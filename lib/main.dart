...
class MaterialItem {
  ...
  String state; // working / not working
  String os;
...
class DepartmentItem {
  ...
  String name;
  String description;
  DepartmentItem({required this.id, required this.name, this.description = ''});
}
...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  final List<EmployeeItem> employees = [
    EmployeeItem(userId: 'U001', nom: 'Dupont', prenom: 'Jean', dateNaissance: '1993-04-02', dateRecrutement: '2021-06-12', email: 'jean.dupont@example.com', department: 'IT'),
    EmployeeItem(userId: 'U002', nom: 'Martin', prenom: 'Alice', dateNaissance: '1990-09-10', dateRecrutement: '2020-01-05', email: 'alice.martin@example.com', department: 'Finance'),
  ];

  final List<DepartmentItem> departments = [
    DepartmentItem(id: 'D-IT', name: 'IT', description: 'Information Technology'),
    DepartmentItem(id: 'D-FIN', name: 'Finance', description: 'Finance Department'),
  ];

  final List<NotificationItem> notifications = [
    NotificationItem(title: 'Backup completed successfully', details: '', time: '2025-08-25'),
    NotificationItem(
